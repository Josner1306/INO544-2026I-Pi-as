...
## 👥 Integrantes y Roles
- Integrante 1: Josner Herrera - 30225069 - Rol: Ingeniero de Datos (Dataset y Preprocesamiento)
- Integrante 2: Jose Valera - 31537197 - Rol: Arquitecto de IA (Modelado y Entrenamiento)
- Integrante 3: Kevin Barreto - 30551786 - Rol: Ingeniero de Despliegue (Exportación ONNX y Pruebas)
...
- Descripción de la Red (CNN): 
    - 3 capas convolucionales con 32, 64 y 128 filtros respectivamente, cada una seguida de MaxPooling 2x2.
    - Aplanamiento (Flatten), capa densa de 128 neuronas con ReLU, Dropout (0.5) para regularización.
    - Capa de salida densa con 1 neurona y activación sigmoide (para clasificación binaria).
...
*Elegimos una tasa de aprendizaje de 0.001 basados en experimentación empírica. Probamos valores de 0.1, 0.01, 0.001 y 0.0001:*
...
Por lo tanto, seleccionamos **0.001** como tasa de aprendizaje óptima para nuestro problema y arquitectura.
